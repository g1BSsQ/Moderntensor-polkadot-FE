...
class SubnetClient:
    ...
    def get_subnet(self, netuid: int) -> SubnetInfo:
        ...
        # Fetch extra fields from the subnets mapping not in getSubnet
        s_mapping = self._contract.functions.subnets(netuid).call()
        ...
        return SubnetInfo(
            ...
            node_count=result[5],
            active=result[6],
            min_stake=s_mapping[6]  # minStake is at index 6 in the struct returning from subnets(netuid)
        )
